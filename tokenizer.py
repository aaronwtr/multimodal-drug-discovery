...
# If we want SimpleTokenizer as default tokenizer
# tokenizer = SimpleTokenizer()

# HugginFace tokenizer
class HugTokenizer:
    def __init__(self, encoding="SMILES") -> None:
        self.encoding = encoding
        pretrained_path = "seyonec/BPE_SELFIES_PubChem_shard00_160k" if self.encoding == "SELFIES" else "seyonec/PubChem10M_SMILES_BPE_450k"
